...
variable_description <- tibble(
  ...
  Description = c(
    ...
    "Final score achieved in the session. Score = coins + (3 × ufos_shot)",
    ...
    "Score normalized by session duration (score ÷ seconds)",
...
# Display by kable
kable(na_table, caption = "Number of NA values per column in game_data_clean")
```
